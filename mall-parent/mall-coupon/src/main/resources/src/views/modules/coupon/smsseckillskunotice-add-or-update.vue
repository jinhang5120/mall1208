<template>
  <el-dialog
    ...
    <el-form-item label="" prop="sessionId">
      <el-input v-model="dataForm.sessionId" placeholder=""></el-input>
    </el-form-item>
    ...
    <el-form-item label="֪ͨ" prop="noticeType">
      <el-input v-model="dataForm.noticeType" placeholder="֪ͨ"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          noticeType: [
            { required: true, message: '֪ͨ不能为空', trigger: 'blur' }
          ]
        }
      }
    },
