<template>
  <el-dialog
    ...
    <el-form-item label="" prop="getType">
      <el-input v-model="dataForm.getType" placeholder=""></el-input>
    </el-form-item>
    ...
    <el-form-item label="ʹ" prop="useTime">
      <el-input v-model="dataForm.useTime" placeholder="ʹ"></el-input>
    </el-form-item>
