<template>
  <el-dialog
    ...
    <el-form-item label="" prop="promotionId">
      <el-input v-model="dataForm.promotionId" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="" prop="promotionSessionId">
      <el-input v-model="dataForm.promotionSessionId" placeholder=""></el-input>
    </el-form-item>
